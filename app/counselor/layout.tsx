                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center px-4 py-1.5 bg-muted/50 rounded-2xl border border-border/50">
                            ...
                            <input
                                ...
                                className="bg-transparent border-none text-xs outline-none w-64 font-bold"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button className="flex items-center gap-2 px-3 py-1.5 hover:bg-muted rounded-xl transition-all">
                            <div className="flex flex-col items-end hidden sm:flex">
                                <span className="text-xs font-bold text-foreground">{user?.full_name || 'Counselor'}</span>
                                <span className="text-[10px] text-muted-foreground uppercase font-black tracking-widest">Specialist</span>
                            </div>
